...
def plot_market_breadth(daily_stats, vnindex_df, ma_lines, ma_label, output_file, plot_start_date="2021-06-25"):
    title = f"📊 Market Breadth: VN-Index and the Ratio of Stocks Trading Above {ma_label}"
        ...
        if symbols:
            ...
            if not df.empty:
                ...
                if not vnindex.empty:
                    ...
                    plot_market_breadth(stats, vnindex, ['pct_MA10', 'pct_MA20', 'pct_MA50', 'pct_MA200'], "MA lines (MA10, MA20, MA50, MA200)", "output/market_breadth_chart.html", plot_start_date=plot_start_date)
